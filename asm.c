...
static opcodew opcodes_table_w[] = {
  ...
  /* 21 */ {(uchar *) "i32.eqz",   0x45, 0,  0},
  /* 22 */ {(uchar *) "i32.eq",    0x46, 0,  0},
  /* 23 */ {(uchar *) "i32.ne",    0x47, 0,  0},
  /* 24 */ {(uchar *) "i32.lt_s",  0x48, 0,  0},
  /* 25 */ {(uchar *) "i32.lt_u",  0x49, 0,  0},
  /* 26 */ {(uchar *) "i32.gt_s",  0x4a, 0,  0},
  /* 27 */ {(uchar *) "i32.gt_u",  0x4b, 0,  0},
  /* 28 */ {(uchar *) "i32.le_s",  0x4c, 0,  0},
  /* 29 */ {(uchar *) "i32.le_u",  0x4d, 0,  0},
  /* 30 */ {(uchar *) "i32.ge_s",  0x4e, 0,  0},
  /* 31 */ {(uchar *) "i32.ge_u",  0x4f, 0,  0},
  /* 32 */ {(uchar *) "i32.add",   0x6a, 0,  0},
  /* 33 */ {(uchar *) "i32.sub",   0x6b, 0,  0},
  /* 34 */ {(uchar *) "i32.mul",   0x6c, 0,  0},
  /* 35 */ {(uchar *) "i32.div_s", 0x6d, 0,  0},
  /* 36 */ {(uchar *) "i32.div_u", 0x6e, 0,  0},
  /* 37 */ {(uchar *) "i32.rem_s", 0x6f, 0,  0},
  /* 38 */ {(uchar *) "i32.rem_u", 0x70, 0,  0},
  /* 39 */ {(uchar *) "i32.and",   0x71, 0,  0},
  /* 40 */ {(uchar *) "i32.or",    0x72, 0,  0},
  /* 41 */ {(uchar *) "i32.xor",   0x73, 0,  0},
};
